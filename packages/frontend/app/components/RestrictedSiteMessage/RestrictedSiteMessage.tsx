...
interface RestrictedSiteMessageProps {
    onClose: () => void;
}

export function RestrictedSiteMessage({ onClose }: RestrictedSiteMessageProps) {
        ...
        >
            ...
            >
                ...
                <a
                    ...
                    href='https://discord.com/invite/ambient-finance'
                    target='_blank'
                    rel='noopener noreferrer'
                    onMouseOver={(e) => (e.currentTarget.style.opacity = '0.8')}
                    onMouseOut={(e) => (e.currentTarget.style.opacity = '1')}
                >
                    Ambient Finance on Discord
                </a>
            </div>
            <div style={{ width: '100%', maxWidth: '200px', margin: '0 auto' }}>
                <Button size='medium' selected onClick={onClose} fullWidth>
                    I understand
                </Button>
            </div>
        </div>
