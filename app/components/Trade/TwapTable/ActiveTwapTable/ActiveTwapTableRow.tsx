...
export default function ActiveTwapTableRow(props: ActiveTwapTableRowProps) {
  ...
  return (
    <div className={styles.rowContainer}>
      ...
      <div className={`${styles.cell} ${styles.sizeCell}`}>{twap.size}</div>
      <div className={`${styles.cell} ${styles.executedSizeCell}`}>{twap.executedSize}</div>
      <div className={`${styles.cell} ${styles.averagePriceCell}`}>{twap.averagePrice}</div>
      <div className={`${styles.cell} ${styles.runningTimeCell}`}>{twap.runningTime}</div>
      <div className={`${styles.cell} ${styles.reduceOnlyCell}`}>{twap.reduceOnly}</div>
      <div className={`${styles.cell} ${styles.creationTimeCell}`}>{twap.creationTime}</div>
